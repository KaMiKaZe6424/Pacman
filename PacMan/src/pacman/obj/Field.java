...
public class Field extends JFrame {
	...
	public Square getSquareAt(int px, int py) {
		System.out.println("Getting Sqare at: " + px + ", " + py);
		for (Square s : sqrs) {
			System.out.println("Testing Sqare at: " + s.getX() + ", " + s.getY());
			if ((px / Square.size) + 1 == s.getX()) {
				if ((py / Square.size) + 1 == s.getY()) {
